 ...
 *
 */
public class YMLLabelProvider extends LabelProvider implements ILabelProvider {
	...
	public Image getImage(Object element) {
		...
		String path="icons/InfoProject.gif"; //$NON-NLS-1$
		...
		System.out.println("YML Icon not found/n"); //$NON-NLS-1$
		return null;
	}
