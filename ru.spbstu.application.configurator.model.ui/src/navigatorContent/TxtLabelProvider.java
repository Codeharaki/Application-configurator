 ...
 *
 */
public class TxtLabelProvider extends LabelProvider implements ILabelProvider {
	...
	public Image getImage(Object element) {
		...
		String path="icons/txt.gif"; //$NON-NLS-1$
		...
		System.out.println("TXT Icon not found/n"); //$NON-NLS-1$
		return null;
	}
